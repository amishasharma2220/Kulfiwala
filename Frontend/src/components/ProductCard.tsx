    ...
    <>
      <div className="group rounded-xl bg-card shadow-card overflow-hidden hover:shadow-warm transition-all duration-300 hover:-translate-y-1">
        <button
          ...
          className="relative overflow-hidden aspect-square block w-full text-left"
        ...
        <div className="p-4">
          <button type="button" onClick={() => setDetailOpen(true)} className="text-left w-full">
            <h3 className="font-heading text-lg font-bold hover:text-primary transition-colors">{product.name}</h3>
